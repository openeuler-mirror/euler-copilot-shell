...
### 7.5 Tool / Agent / Skill / SubAgent Presenter
...
### 7.6 Permission / Question Manager
...
快捷模式与 REPL 共享同一会话集合，会话由 Session Manager（见 [§7.1](#71-session-manager)）统一管理。
