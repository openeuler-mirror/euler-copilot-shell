...
采用 witty --init 方式轻量安装 openEuler Intelligence 时，euler-copilot-tune 会作为默认的 MCP 服务安装到服务器上，MCP 服务以 systemctl 管理，服务名称为：tune-mcp_server。如果需要使用**最新版本的 euler-copilot-tune**，可以源码下载安装，命令如下：
