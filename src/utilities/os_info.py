...
def _exec_shell_cmd(cmd: list) -> subprocess.CompletedProcess:
...
def _porc_linux_info(shell_result: subprocess.CompletedProcess):
...
def _porc_macos_info(shell_result: subprocess.CompletedProcess):
    macos_info = {}
