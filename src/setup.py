...
def add_py_files(module_name):
    return [os.path.join(module_name, f) for f in os.listdir(module_name) if f.endswith(".py")]
...
setup(
    name="copilot",
    version="0.9.2",
    description="EulerCopilot Command Line Assistant",
    author="Hongyu Shi",
    ...
    entry_points={"console_scripts": ["copilot=copilot.__main__:entry_point"]},
)
